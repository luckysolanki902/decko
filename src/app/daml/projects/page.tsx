...
export default function DAMLProjectsPage() {
  const { completedItems } = useProgress('daml');
        ...
        <div>
            ...
            <div className="flex items-center gap-3">
              ...
              {totalProjects > 0 && (
                <div className="flex-1 max-w-xs h-2 rounded-full bg-[#F2F1EE] dark:bg-[#232321] overflow-hidden">
                  <div 
                    className="h-full bg-[#B87D6C] transition-all duration-300"
          ...
          {completedProjects.length > 0 ? (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-medium text-[#9A6452] dark:text-[#D4A090] bg-[#F0E5E0] dark:bg-[#2A2018] px-2 py-0.5 rounded">
                          {project.phase}
                        </span>
            ...
            <div className="bg-white dark:bg-[#1A1A18] rounded-xl p-8 border border-[#E5E4DF] dark:border-[#2C2B28] text-center mb-8">
              <Trophy className="w-12 h-12 text-[#B87D6C] dark:text-[#D4A090] mx-auto mb-4" />
